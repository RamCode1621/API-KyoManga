...
querys.addManga=(nombreManga,numCapitulos,estadoID,demografiaID,mangakaID,descripcion,portada)=>{
    return `INSERT INTO Manga (nombre, numeroCapitulos, Estado_id, Demografia_id, Mangaka_id, Descripcion,portada) 
    VALUES ('${nombreManga}',${numCapitulos} ,${estadoID},${demografiaID},${mangakaID}, ${descripcion}, ${portada})`
}
